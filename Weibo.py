...
def main():
    try:
        ...
        #step 3 ��ȡAccess Token
        r = client.request_access_token(input("Input code:"))#������Ȩ��ַ�л�õ�CODE
        client.set_access_token(r.access_token, r.expires_in)
        #step 4 ʹ�û�õ�OAuth2.0 Access Token����API
        print(client.get.account__get_uid())
        print(client.post.statuses__update(status='测试Python3 + OAuth 2.0发微博 ' + str(time.time())))
        #print(client.upload.statuses__upload(status='����Python3 OAuth 2.0��ͼƬ��΢�� ' + str(time.time()), pic=open('test.png', 'rb')))
